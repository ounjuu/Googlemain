...
1. 구글 메인 페이지를 똑같이 만들어 보고 싶어서 배운 것으로 제작하여 봄<br/>
2. HTML과 CSS만 사용하여 구현<br/><br/>
...
2. CSS: display, margin, position, border-radius, z-index, hover 등 사용
3. a 태그를 사용하여 클릭 시 실제 페이지로 이동
<img src="https://github.com/user-attachments/assets/888a27c1-84b7-4297-9d57-86ca2ac58ef7" alt="googleimg" width = 100%/>
<br/>
<br/>
